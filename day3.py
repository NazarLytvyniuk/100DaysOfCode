...
if choice == "left":
  ...
  if choice == "wait":
    ...
    if choice == "yellow":
      print("Gongratulations. You won the game!")
    else:
      print("Oppps... You enter a room of beasts. Game Over.")
  else:
    print("Oppps... There is a crocodil in the lake. Game Over.")
else:
  print("Oppps... You fell into a pit. Game Over.")